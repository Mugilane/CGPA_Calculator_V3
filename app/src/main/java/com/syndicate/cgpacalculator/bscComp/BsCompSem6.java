...
public class BsCompSem6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bs_comp_sem6);
    ...
    public float calculate()
    {
        ...
        float res = ((float)val1*4+(float)val2*4+(float)val3*4+(float)val7*2+(float)val8*2)/30;
