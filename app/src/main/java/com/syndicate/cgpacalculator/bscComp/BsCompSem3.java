...
public class BsCompSem3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bs_comp_sem3);
    ...
    public float calculate()
    {
        ...
        float res = ((float)val1*4+(float)val2*4+(float)val3*4+(float)val4*4+(float)val5*4+(float)val7*2+(float)val8*2)/30;
