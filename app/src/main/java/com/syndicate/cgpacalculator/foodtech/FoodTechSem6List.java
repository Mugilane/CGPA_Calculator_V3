...
public class FoodTechSem6List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_tech_sem6_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FoodTechSem6List.this, FoodTechSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(FoodTechSem6List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public float calculate() {
        ...
        float res = ((float) val1 * 4 + (float) val2 * 4 + (float) val3 * 4 + (float) val4 * 4 + (float) val5 * 4 + (float) val6 * 2 + (float) val7 * 2 + (float) val8 * 1 ) / 25;
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(FoodTechSem6List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
