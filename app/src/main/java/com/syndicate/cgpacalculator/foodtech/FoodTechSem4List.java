...
public class FoodTechSem4List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_tech_sem4_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FoodTechSem4List.this, FoodTechSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(FoodTechSem4List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(FoodTechSem4List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
