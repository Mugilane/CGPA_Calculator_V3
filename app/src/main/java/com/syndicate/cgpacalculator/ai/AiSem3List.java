...
public class AiSem3List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ai_sem3_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AiSem3List.this, AiSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(AiSem3List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(AiSem3List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
