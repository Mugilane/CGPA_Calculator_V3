...
public class AiSem5List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ai_sem5_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AiSem5List.this, AiSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(AiSem5List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(AiSem5List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
