...
public class AiSem8List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ai_sem8_list);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AiSem8List.this, AiSemList.class);
        ...
        cpyIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(AiSem8List.this, "GPA Copied", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void write() {
        ...
        try {
            ...
            Toast.makeText(AiSem8List.this, "Added To CGPA ", Toast.LENGTH_SHORT).show();
